...
static:
  ...
  Sample LoadOGG(immutable(string) file_name) {
    ...
    if ( x != 0 ) {
      ...
      writeln("load OGG error: "~ to!string(x));
  ...
  bool Check_AL_Errors() {
    ...
    switch ( error ) {
      default:
        writeln("OpenAL error: unknown");
      break;
      case AL_INVALID_NAME:
        writeln("OpenAL error: AL_INVALID_NAME");
      break;
      case AL_INVALID_ENUM:
        writeln("OpenAL error: AL_INVALID_ENUM");
      break;
      case AL_INVALID_VALUE:
        writeln("OpenAL error: AL_INVALID_VALUE");
      break;
      case AL_INVALID_OPERATION:
        // writeln("AL_INVALID_OPERATION");
      break;
      case AL_OUT_OF_MEMORY:
        writeln("OpenAL error: AL_OUT_OF_MEMORY");
      break;
    }
    return true;
  }
...
/** */
private immutable(string)[] sounds;
private uint cur_slot;
/**
...
void Update_Sound(int nanosecond_duration = 0) {
  import std.concurrency;
  import core.time;
