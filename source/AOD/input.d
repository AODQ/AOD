...
float R_Mouse_X(bool camoffset) {
  return InputEngine.mouse_x +
    (camoffset ? Camera.R_Position.x : 0);
}
/**
Params:
  camoffset = Whether to offset the position of the mouse with the camera
...
float R_Mouse_Y(bool camoffset) {
  return InputEngine.mouse_y +
    (camoffset ? Camera.R_Position.y : 0);
}
/**
params:
  camoffset = Whether to offset the position of the mouse with the camera
...
string Key_To_String(SDL_Keycode k) {
  ...
  switch ( k ) {
    ...
    case MouseBind.Left                  : return "mouseleft"          ;
    case MouseBind.Right                 : return "mouseright"         ;
    case MouseBind.Middle                : return "mousemiddle"        ;
    case MouseBind.X1                    : return "mouse4"             ;
    case MouseBind.X2                    : return "mouse5"             ;
    case MouseBind.Wheelup               : return "mwheelup"           ;
    case MouseBind.Wheeldown             : return "mwheeldown"         ;
